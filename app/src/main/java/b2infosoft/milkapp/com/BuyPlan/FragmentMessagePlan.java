...
public class FragmentMessagePlan extends Fragment implements PaytmPaymentTransactionCallback, UpdateList, PaytmCheckSumListener, PlanListListener {
    ...
    private SMSPlanAdapter adapter;
    private SwipeRefreshLayout pullToRefresh;
    private RecyclerView recyclerView;
    private LinearLayoutManager layoutManager;
    private List<BeanSMSPlan> mList=new ArrayList<>();
    private String strFrom = "", checksum = "", order_id = "", validity = "UnLimited",
            customer_id = "", amount = "", type = "sms", data = "", strTitle = "", STATUS = "TXN_FAILURE";
    ...
    private void manageToolbar() {
        toolbar.setTitle(mContext.getString(R.string.message));
