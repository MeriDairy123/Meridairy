...
public class DeliverBoyMilkPurchaseEntryListAdapter extends RecyclerView.Adapter<DeliverBoyMilkPurchaseEntryListAdapter.MyViewHolder> {
    ...
    public DeliverBoyMilkPurchaseEntryListAdapter(Context mContext, ArrayList<CustomerEntryListPojo> entryList, RefreshBuyMilkEntryList refreshEntryList) {
...
//    }
    ...
    private void popUpWithIcon(View view, int position) {
        ...
        inflater.inflate(R.menu.deliveryboy_entrymenu, menuBuilder);
