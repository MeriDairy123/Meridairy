...
public class Deliveryboy_dashboard_Item extends RecyclerView.Adapter<Deliveryboy_dashboard_Item.MyViewHolder> {

    private Context mContext;
    private OnClickInDashboardAdapter clickInDashboardAdapter;
    private List<Dashboard_item> albumList;

    public Deliveryboy_dashboard_Item(Context mContext, List<Dashboard_item> albumList,
