...
public class SignatureFragment extends Fragment implements FragmentBackPressListener {
    ...
    String transactionID = "", CutomerID = "", CustomerName = "", CustomerFatherName = "", unic_customer = "", type = "", fromWhere = "";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        CustomerFatherName = bundle.getString("CustomerFatherName");
            ...
            public void handleResponse(String response) {
                ...
                try {
                    ...
                    if (mainObj.getString("status").equals("success")) {
                        ...
                        } else if (fromWhere.equals("AddEntryCustom")) {
                            fragment = new PurchaseMilkEntryFullScreenFragment();
                            goNextFragmentReplace(mContext, fragment);
                        } else if (fromWhere.equals("SaleEntryCustom")) {
