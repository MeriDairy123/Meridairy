...
public class ViewAllEntryAdapter extends RecyclerView.Adapter<ViewAllEntryAdapter.MyViewHolder> {

    public Context mContext;
    public ArrayList<TenDaysMilkSellHistory> mList = new ArrayList<>();

    public ViewAllEntryAdapter(Context mContext, ArrayList<TenDaysMilkSellHistory> transectionListPojoArrayList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_all_entry_list_row, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (!mList.get(position).fat.equals("-") && !mList.get(position).fat.equals("")) {
