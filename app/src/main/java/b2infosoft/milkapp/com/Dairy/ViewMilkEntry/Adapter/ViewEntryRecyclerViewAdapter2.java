...
/**
 * Created by B2infosoft on 8/5/2017.
 */

public class ViewEntryRecyclerViewAdapter2 extends RecyclerView.Adapter<ViewEntryRecyclerViewAdapter2.MyViewHolder> {
    public Context mContext;
    public ArrayList<ViewEntryByDatePojo> mList = new ArrayList<>();


    public ViewEntryRecyclerViewAdapter2(Context mContext, ArrayList<ViewEntryByDatePojo> entryList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.etFat.setText(String.format("%.1f", mList.get(position).getFat()));
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView etName, etFat, etWeight, etTotal, etId, etRate, tvBonus;
