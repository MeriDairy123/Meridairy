...
public class SaleReturnListFragment extends Fragment implements UpdateList {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        toolbar.setTitle(mContext.getString(R.string.Sale) + " " + mContext.getString(R.string.strReturn));
        ...
        tvAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                fragment = new AddReturnSaleFragment();
    ...
    private void recyclerViewUI() {
        adapter = new ReturnSaleItemAdapter(mContext, mList, this);
    ...
    public void getPurchaseList() {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equals("success")) {
                        ...
                        for (int i = 0; i < jsonData.length(); i++) {
                            ...
                            System.out.println("jsonProdArray>>>>>" + jsonProdArray);
        ...
        serviceCaller.execute(Constant.getSaleInvoiceListAPI);
