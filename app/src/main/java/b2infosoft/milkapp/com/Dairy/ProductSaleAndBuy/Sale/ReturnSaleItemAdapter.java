...
public class ReturnSaleItemAdapter extends RecyclerView.Adapter<ReturnSaleItemAdapter.MyViewHolder> {
    ...
    String strTable = "sale_return";

    public ReturnSaleItemAdapter(Context mContext, ArrayList<BeanPurchaseItem> itemArrayList, UpdateList onClickInAdapter) {
        this.mContext = mContext;
        this.mList = itemArrayList;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        String inoNo = mContext.getString(R.string.invoice) + "  : #" + mList.get(position).getInvoice_number();
        ...
        holder.tvProductWeight.setText(inoNo);
