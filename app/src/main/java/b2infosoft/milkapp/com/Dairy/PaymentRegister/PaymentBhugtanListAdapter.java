...
public class PaymentBhugtanListAdapter extends RecyclerSwipeAdapter<PaymentBhugtanListAdapter.MyViewHolder> {
    ...
    @Override
    public PaymentBhugtanListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(mContext).inflate(R.layout.layout_payment_register_row, parent, false);
        return new PaymentBhugtanListAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final PaymentBhugtanListAdapter.MyViewHolder holder, final int position) {
