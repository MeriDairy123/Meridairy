...
public class ReturnPurchaseItemAdapter extends RecyclerView.Adapter<ReturnPurchaseItemAdapter.MyViewHolder> {
    ...
    public ReturnPurchaseItemAdapter(Context mContext, ArrayList<BeanPurchaseItem> item, UpdateList onClickInAdapter) {
