...
public class SaleListFragment extends Fragment implements UpdateList {
    ...
    SaleInvoiceItemAdapter adapter;
    SwipeRefreshLayout pullToRefresh;
    RecyclerView recyclerView;
    SessionManager sessionManager;
    Fragment fragment = null;
    String strTable = "sale";
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        toolbar.setTitle(mContext.getString(R.string.Sale));
        ...
        tvAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                fragment = new AddSaleInvoiceFragment();
    ...
    private void recyclerViewUI() {
        adapter = new SaleInvoiceItemAdapter(mContext, mList, this);
