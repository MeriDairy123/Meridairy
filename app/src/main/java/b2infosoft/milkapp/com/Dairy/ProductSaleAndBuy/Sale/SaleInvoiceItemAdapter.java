...
public class SaleInvoiceItemAdapter extends RecyclerView.Adapter<SaleInvoiceItemAdapter.MyViewHolder> {
    ...
    public SaleInvoiceItemAdapter(Context mContext, ArrayList<BeanPurchaseItem> transectionListPojoArrayList, UpdateList onClickInAdapter) {
