...
public class PurchaseListFragment extends Fragment implements UpdateList {
    ...
    PurchaseInvoiceItemAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        toolbar.setTitle(mContext.getString(R.string.Purchase));
        ...
        tvAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                fragment = new AddPurchaseInvoiceFragment();
    ...
    private void recyclerViewUI() {
        adapter = new PurchaseInvoiceItemAdapter(mContext, mList, this);
