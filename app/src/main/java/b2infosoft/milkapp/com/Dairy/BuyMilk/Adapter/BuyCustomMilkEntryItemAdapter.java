...
public class BuyCustomMilkEntryItemAdapter extends RecyclerView.Adapter<BuyCustomMilkEntryItemAdapter.MyViewHolder> {
    ...
    public BuyCustomMilkEntryItemAdapter(Context mContext, ArrayList<CustomerEntryListPojo> entryList, RefreshBuyMilkEntryList listner) {
