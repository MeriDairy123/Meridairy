...
public class SearchPlaceFragment extends Fragment implements View.OnClickListener, AdapterView.OnItemClickListener {
    private static final String API_Web1 = "AIzaSyDKZk2naZ8z8i";
    private static final String API_Web2 = API_Web1 + "Eahpq_GhwwzX-l5yDwjoc";
    ...
    GPSTracker gps;
    String address = "", city = "", state = "", postCode = "", country = "";
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_search_place, container, false);
        mContext = getActivity();
        broadcaster = LocalBroadcastManager.getInstance(mContext);
        msgintent = new Intent(strKeyAddress);
    ...
    private void initView() {
        ...
        layoutUseGPS = view.findViewById(R.id.layoutUseGPS);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iconSearch:
                ...
                autoCompView.setAdapter(new GooglePlacesAutocompleteAdapter(mContext, R.layout.list_location_item));
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        /*Intent intent = new Intent(mContext, BarListActivity.class);
        Bundle bundle = new Bundle();
        // bundle.putString("fromWhere", "SearchPlace");
        bundle.putString("fromWhere", "SearchList");
        bundle.putString("lat", "" + firstLatitude);
        bundle.putString("lang", "" + firstLongitude);
