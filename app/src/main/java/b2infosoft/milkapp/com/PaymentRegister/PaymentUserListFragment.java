...
import b2infosoft.milkapp.com.Dairy.PaymentRegister.PaymentBhugtanListAdapter;
...
public class PaymentUserListFragment extends Fragment implements View.OnClickListener, OnRefreshPaymentRegister {
    ...
    b2infosoft.milkapp.com.Dairy.PaymentRegister.PaymentBhugtanListAdapter adapter;
    SwipeRefreshLayout pullToRefresh;
    RecyclerView recyclerView;
    SessionManager sessionManager;

    int viewAllCustomer = 0;
    String startDate = "", endDate = "", strFrom = "", strTitle = "", customerID = "", userGroupId = "";
    Document document;
    File pdfFile;
                    ...
                    if (jsonObject.getString("status").equalsIgnoreCase("success")) {
                        ...
                        for (int i = 0; i < jsonData.length(); i++) {
                            ...
                            mListTendayHistory.add(new TenDaysMilkSellHistory(
                                    ...
                                    user_data.getString("phone_number"), dataList, userTransactions
                            ));
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if (Pdfcreted.equals("true")) {
                                ...
                                createCustomerPDF(milkSellHistories.get(finalI).getUser_data_unic_customer(),
                                        milkSellHistories.get(finalI).getUser_data_name(),
                                        milkSellHistories.get(finalI).getUser_data_phone_number(),
                                        milkSellHistories.get(finalI).getOpening_balance(), pdfList, userTransactions);
    ...
    public void createCustomerPDF(String unic_id, String userName,
                                  String mobile_no, String openingBalance,
